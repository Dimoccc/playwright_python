...
def test_set_input_files(page):
    ...
    page.set_input_files("#formFile", "data/hello.txt")
    page.locator("#file-submit").click()

def test_filechooser_input(page):
    page.goto('https://zimaev.github.io/upload/')
    page.on("filechooser", lambda file_chooser: file_chooser.set_files("data/hello.txt"))
...
def test_with_input(page):
    ...
    file_chooser.set_files("data/hello.txt")